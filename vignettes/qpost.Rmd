...
**Using `qpost()`:**
1. Run `qpost()` (via the Addin or console, in RStudio or Positron)
2. Fill in the dialog: title, author (pre-filled from options), date (today's date suggested), categories
3. Optionally select a featured image from your filesystem
4. Click **Create**
5. The post is created and opened in the editor
