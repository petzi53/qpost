...
`qpost()` displays a dialog window where you can enter the data for
the YAML header of a new blog post.

```{r screenshot, fig.align='center', out.width='75%', echo=FALSE, fig.cap='Dialog window for creating a blog post', fig.alt='Dialog windows shows input field for title, author, date and subtitle'}
knitr::include_graphics("man/figures/qpost-dialog.png")
```
...
-   Choose "Tools -\> Modify Keyboard Shortcuts ..." from the RStudio
    menu.
...
Quarto was generally my main incentive to start with the qpost
